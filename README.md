TrackFyre: Users select a component of a website that they want to track changes in (using a Chrome extension). Our app sends the user an email when the component changes.
